...
הצבע, סבב א'), ‏#79 (סבב ב') ו־#81 (שישה־עשר הליקויים מסקירת הבעלים בנייד). כולם frontend בלבד —
אין מיגרציה, אין Edge, אין תלות חדשה — ולכן שורת "Frontend / נכס ציבורי" במטריצת ה־rollout היא
הדרישה כולה. ‏Pages מגיש עדיין את ה־bundle שקדם להם.
