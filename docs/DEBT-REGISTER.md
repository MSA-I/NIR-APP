...
- **הסיכון:** דייר יכול לחרוג מהתקרה שסוכמה איתו בעמודים בלי שהמערכת תעצור אותו — העלות היא לנו,
  לא לו. **‏19.08.2026 — הסיכון הפך ממשי:** ‏#157 הוכרעה (‏Free 25 · Pro 300), כלומר מגבלת
...
- **המנגנון פעיל מ-19.08.2026:** ‏`0163` קבע את המספרים (‏#168) כמכסת המסמכים כפול תקרת 20
...
- **הסיכון:** מוגבל בתקרה של 200 הרשמות מוצלחות ליום (‏OPEN-DECISIONS #162), ולכן הוא רעש ולא
...
- **ראיה:** ‏`0159` · `supabase/functions/public-signup/index.ts` · `OPEN-DECISIONS #166`.
