...
insert into auth.users (id, email) values
  ...
  ('24000000-0000-4000-8000-000000000003', 'p4-order-office-a-2@example.test'),
...
insert into public.profiles (id, org_id, full_name, role) values
  ...
  ('24000000-0000-4000-8000-000000000003', '14000000-0000-4000-8000-000000000001', 'P4 office A', 'office'),
