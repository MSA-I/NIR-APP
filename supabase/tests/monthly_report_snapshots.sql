...
insert into auth.users (id, email) values
  ...
  ('c5740000-0000-0000-0000-000000000004', 'snapshot-accountant-a-2@example.test'),
...
insert into public.profiles (id, org_id, full_name, role) values
  ...
  ('c5740000-0000-0000-0000-000000000004', 'a5740000-0000-0000-0000-000000000001', 'Snapshot accountant A', 'accountant'),
...
-- Persist the same immutable 0099 approval assessment used by production rather than seeding an
...
begin
  ...
  raise exception 'snapshot test failure: accountant creation was accepted';
exception when insufficient_privilege then
  if sqlerrm not like '%monthly_report_snapshot_not_authorized%' then raise; end if;
end
$$;
