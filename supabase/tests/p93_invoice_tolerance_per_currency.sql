-- P93 — ₪1 is not ¥1, and the invoice stopped pretending otherwise.
--
...
create function pg_temp.p93_assert(p_condition boolean, p_message text)
returns void language plpgsql as $$
begin
  if not coalesce(p_condition, false) then
    raise exception 'P93 invoice tolerance assertion failed: %', p_message;
  end if;
end
$$;

/* One reason out of the assessment, by code. */
create function pg_temp.p93_reason(p_raw jsonb, p_code text)
...
values ('10860000-0000-4000-8000-000000000001', 'P93 org', 'active', 18, 'ILS', 'IL');

insert into public.suppliers(id, org_id, name, status, default_currency, country_code) values
('40860000-0000-4000-8000-000000000001', '10860000-0000-4000-8000-000000000001', 'P93 ILS', 'active', 'ILS', 'IL'),
('40860000-0000-4000-8000-000000000002', '10860000-0000-4000-8000-000000000001', 'P93 JPY', 'active', 'JPY', 'JP'),
('40860000-0000-4000-8000-000000000003', '10860000-0000-4000-8000-000000000001', 'P93 KWD', 'active', 'KWD', 'KW');
...
('f8600000-0000-4000-8000-000000000001', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000001', 'P93-ILS-OK', '2026-08-01', 100, 18, 117.50, 'ILS'),
...
('f8600000-0000-4000-8000-000000000002', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000001', 'P93-ILS-BAD', '2026-08-01', 100, 18, 119.50, 'ILS'),
...
('f8600000-0000-4000-8000-000000000003', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000002', 'P93-JPY-OK', '2026-08-01', 10000, 1800, 11750, 'JPY'),
...
('f8600000-0000-4000-8000-000000000004', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000002', 'P93-JPY-BAD', '2026-08-01', 10000, 1800, 11950, 'JPY'),
...
('f8600000-0000-4000-8000-000000000005', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000003', 'P93-KWD-BAD', '2026-08-01', 100.000, 18.000, 118.500, 'KWD'),
-- KWD, off by 0.050 dinar. Inside it.
('f8600000-0000-4000-8000-000000000006', '10860000-0000-4000-8000-000000000001',
 '40860000-0000-4000-8000-000000000003', 'P93-KWD-OK', '2026-08-01', 100.000, 18.000, 118.050, 'KWD');

-- ---- 1. The shekel business feels nothing. --------------------------------------------------
select pg_temp.p93_assert(
  pg_temp.p93_reason(private.invoice_three_way_raw(
...
select 'P93_invoice_tolerance_per_currency_passed' as result;
