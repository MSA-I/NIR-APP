...
create function pg_temp.p80_attempt(p_actor uuid, p_role text, p_sql text)
...
select pg_temp.p80_assert(
  pg_temp.p80_attempt('7b790000-0000-4000-8000-000000000011', 'postgres',
...
select pg_temp.p80_assert(
  pg_temp.p80_attempt('7b790000-0000-4000-8000-000000000012', 'postgres',
    $sql$insert into public.bank_imports (org_id, filename, file_hash, column_mapping)
