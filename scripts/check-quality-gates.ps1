...
try {
  ...
  try {
    ...
    Invoke-SqlTest "supabase\tests\p48_product_display_name.sql" "Canonical product names: owner/office only, reason mandatory, blank unrepresentable, no direct column write and every rename audited"
