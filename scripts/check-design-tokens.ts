 ...
 *
 * Owner ruling 27.08.2026 (OPEN-DECISIONS #277): «צבע הנייר נשאר. המנויים זה הדבר היחיד שיכול
...
for (const sheet of stylesheets) {
  ...
  violations.push({
    ...
    why:
      ...
      '(OPEN-DECISIONS #277), and that exemption covers the plan card alone. Put the colour in ' +
...
console.log(
  `check:tokens passed: ${scanned} .ts/.tsx files with zero raw palette classes, zero hex literals, ` +
    ...
    'is styles/plan-card.css (OPEN-DECISIONS #277).',
);
