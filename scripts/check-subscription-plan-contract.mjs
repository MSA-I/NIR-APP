...
const migration = read('supabase/migrations/0246_plan_capability_ladder.sql');
...
forbidText(migration, '#196 forbids it', '0246 must not restore superseded guard');

requireText(decisions, '| 295 |', 'display-vs-billing owner decision');
