...
const PATTERNS: [RegExp, string][] = [
  ...
  [/payment_execution_conflict|payment_request_idempotency_conflict|invoice_idempotency_conflict|receipt_idempotency_conflict|bank_payment_idempotency_conflict/i,
  ...
  [/invoice_create_not_authorized|invoice_review_not_authorized|price_write_not_authorized|price_import_not_authorized|month_export_not_authorized|not_authorized/i,
