...
const PATTERNS: [RegExp, string][] = [
  ...
  [/monthly_report_snapshot_month_invalid/i,
    'חודש הדוח הסופי אינו תקין. בחר חודש ונסה שוב.'],
  [/monthly_report_snapshot_immutable/i,
    'דוח סופי נעול אינו ניתן לשינוי או למחיקה.'],
  [/monthly_report_snapshot_not_authorized/i,
    'רק מנהל או הנהלת חשבונות רשאים ליצור דוח סופי נעול.'],
