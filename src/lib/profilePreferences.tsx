 ...
 *
 * IT WAS `ProfileLocaleSync` UNTIL 31.08.2026. Migration 0268 gave `profiles` a `theme` column
 ...
 * happened to resolve. That distinction is the whole reason 0253 and 0268 allow the column to be
 * NULL at all.
 */
