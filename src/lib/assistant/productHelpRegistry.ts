...
const ENTRIES: readonly ProductHelpEntry[] = [
  ...
  },
  {
    ...
    steps: [
      'משתמשים בחיפוש שבכותרת כדי להגיע לספק, מוצר, הזמנה, חשבונית או מסמך בלי לעבור ידנית בין המסכים.',
    ],
  ...
  },
  {
    ...
    steps: [
      'אזור "דורש טיפול" מרכז חריגים ומשימות לפי דחיפות. לוחצים על שורה כדי לעבור למקום שבו מטפלים בה, או פותחים את מסך ההתראות לתור המלא.',
    ],
  ...
  },
  {
    ...
    steps: [
      'הניווט מחלק את העבודה למסכים יומיומיים, ניהול ובקרה. בטלפון פותחים אותו בכפתור התפריט; בדסקטופ משתמשים בקישורים ובקבוצות שבכותרת.',
    ],
  ...
  },
  {
    ...
    steps: [
      'נכנסים למסך הספקים כדי לבנות את רשימת העסקים שמהם הארגון רוכש.',
      'לוחצים "ספק חדש" וממלאים את פרטי הספק. פרטי בנק נשמרים במסלול מוגן ונפרד ואינם נדרשים כדי להתחיל.',
    ],
    source: 'src/pages/Suppliers.tsx',
    updated_at: '2026-08-27',
  },
  {
    ...
    steps: [
      'פותחים "הזמנה חדשה" כדי לבחור את המוצרים והכמויות שנדרשים עכשיו.',
      'המסלול מתקדם מבחירת מוצרים להשוואת ספקים ולסיכום. המערכת מציגה מחיר, זמינות ומינימום, והמשתמש מאשר לפני יצירת ההזמנות.',
    ],
  ...
  },
  {
    ...
    steps: [
      'במסך קבלת הסחורה בוחרים הזמנה שממתינה לקבלה, מתעדים מה הגיע בפועל ומסמנים חוסר, נזק או החזרה. חריגה נשמרת לטיפול ואינה נעלמת בתוך הקבלה.',
    ],
  ...
  },
  {
    ...
    steps: [
      'במסך המסמכים לוחצים "העלאת מסמך" ובוחרים קובץ או צילום. המקור נשמר, ולאחר הקריאה עוברים על התוצאה לפני שהיא הופכת לעובדה עסקית.',
    ],
  ...
  },
  {
    ...
    steps: [
      'בדוח החודשי בוחרים חודש, בודקים חריגים ונתונים חסרים, ורק לאחר הבדיקה יוצרים גרסה סופית נעולה לייצוא או למסירה לרואה החשבון.',
    ],
  ...
  },
  {
    ...
    roles: ['owner'],
    route: 'onboarding',
    label: 'מתחילים להקים את העסק',
    steps: [
      'לוחצים "פתיחת אשף ההקמה" ומתחילים בפרטי העסק. האשף ממשיך לקטגוריות, ספקים, מוצרים ומחירון, ואפשר לעצור ולחזור בכל שלב.',
    ],
...
export const PRODUCT_HELP_KEYWORDS: Readonly<Record<string, readonly string[]>> = {
  ...
  use_global_search: ['חיפוש', 'חיפוש גלובלי', 'למצוא ספק', 'למצוא מוצר'],
  see_dashboard_attention: ['דורש טיפול', 'מה דחוף', 'משימות בדשבורד'],
  navigate_product_workspace: ['ניווט', 'תפריט', 'איפה נמצא', 'לעבור מסך'],
  add_supplier: ['ספק חדש', 'הוספת ספק', 'להוסיף ספק'],
