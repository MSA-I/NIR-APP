...
/**
 * #299 collapsed the supplier bank flow's two consecutive dialogs into this one, by letting the
 * step-up carry an optional reason. The risk of that is a gate that quietly softened while a field
 * was being added, so what is measured here is both: the field behaves like #299 requires, and
