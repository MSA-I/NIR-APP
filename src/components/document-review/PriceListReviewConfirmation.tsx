      ...
      {receipt && (
        <div className="mt-4 rounded-lg border border-done-line bg-done-wash p-4" aria-live="polite">
          ...
          <dl className="mt-3 grid gap-2 text-sm sm:grid-cols-2">
            <div><dt className="inline font-medium">{t('priceListReview.text_64')} </dt><dd className="inline break-all tech-id" dir="ltr">{receipt.submission_id}</dd></div>
            <div><dt className="inline font-medium">{t('priceListReview.text_65')} </dt><dd className="inline num">{receipt.revision}</dd></div>
