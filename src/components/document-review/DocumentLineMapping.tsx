 ...
 *
 * The currency comes from the DOCUMENT and is passed in, because a line does not carry one: the
 * evidence currency is a property of the page the reader is looking at (0227). A price with no
...
export function DocumentLineMapping({ lines, supplierId, currency, mapped, onMap, disabled = false }: {
  ...
  /** The document's own evidence currency (0227). Null when intake could not read one. */
