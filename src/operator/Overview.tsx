    ...
    <div className="dashboard-depth flex flex-col gap-5">
      ...
      <div className="grid gap-4 lg:grid-cols-12">
        <AttentionZone
          ...
          /* Null, and deliberately: every item on this console is a COUNT of tenants or operators,
             not money, so there is no amount to order by currency — and the platform console spans
             every tenant, so it has no base currency of its own to borrow. */
          baseCurrency={null}
        />
        <TeamCard
