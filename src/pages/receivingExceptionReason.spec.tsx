 ...
 *
 * #299 removed the audit-reason boxes that only ever produced "asdf", and kept the ones whose text
...
describe('the manual-exception box asks the investigator\'s question', () => {
  ...
  it('shows the question on screen and still lets an empty box through', async () => {
    ...
    // Nothing typed, and the button is live — #299 forbids the block even here.
