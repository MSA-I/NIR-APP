 ...
 * any more (#290), and both boundaries refuse a blank one — the RPC with `reason_required` (22023)
...
export default function DocumentOperations() {
  ...
  async function reprocess() {
    // The reason left this dialog (#290), so `reason` left this guard with it. What the guard was
  ...
  return (
    <div className="min-w-0 space-y-6">
      ...
      {/* Both confirmations stay: a document already handed to the queue cannot be pulled back out,
          ...
          the ledger keeps a truthful sentence either way (#290). */}
