      ...
      <RecordHeader
        ...
        meta={<>
          ...
          <span className="num font-semibold text-ink-body">
            {t('supplierProposal.fmtMoneyExact')} {fmtMoneyExact(proposal.total_delta)}
          </span>
        </>}
        ...
        <div className="card space-y-3 p-4">
          <div>
            <label className="label" htmlFor="proposal-decision-reason">
              {t('supplierProposal.decisionReasonLabel')} {anyRejected ? t('supplierProposal.text_10') : t('supplierProposal.text_11')}
            </label>
            <input
          ...
          {reasonMissing && (
            <p className="text-sm text-alert-fg">{t('supplierProposal.text_13')}</p>
          )}
