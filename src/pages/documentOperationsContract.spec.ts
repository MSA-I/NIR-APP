...
describe('document control capability and UX contract', () => {
  ...
  it('renders the recovery task at mobile width and announces its result', async () => {
    ...
    /* #290: the confirmation stayed — a recovery Edge call has no inverse — but the reason textarea
  ...
  /**
   * #290 drew a line through this screen: the two confirmations are load-bearing (there is no
