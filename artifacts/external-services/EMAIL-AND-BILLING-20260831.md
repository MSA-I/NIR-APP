...
the DMARC mailbox. That is an owner decision, recorded as `#310`.
...
domain-wide delegation. Underneath that sits `#310`: the Workspace domain is
...
2. **Decide `#310`** — Cloudflare Email Routing (free, forward only, no send-as) or Google
