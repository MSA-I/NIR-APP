...
export const OWNER_ROLE_PROMPT: RolePrompt = {
  ...
  roleSpecificRules: [
    ...
    'כאשר מוצגת אזהרה על זיכויים פתוחים, יש לקרוא אותה, לסמן הבנה ולאשר רק דרך “אישור חריג ללא קיזוז הזיכוי” עם סיבה כתובה; אין לנסות אישור רגיל ואין להניח שהזיכוי קוזז.',
