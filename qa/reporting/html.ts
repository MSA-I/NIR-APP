...
<section class="panel"><h2>כיסוי חסום או מדולג</h2><div class="table-wrap"><table><thead><tr><th>מזהה</th><th>שם</th><th>תפקיד</th><th>מצב</th><th>חיוביות</th><th>סיבה</th></tr></thead><tbody>${coverage || '<tr><td colspan="6">אין</td></tr>'}</tbody></table></div></section>
