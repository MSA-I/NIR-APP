...
מחזיר את המסלול הישיר שנבחר למוצר: owner/office/kitchen מקבלים „הזמנה חדשה”, „מרכז הבקרה”,
„צילום מסמך” ו„קבלת סחורה”. ‏„חשבונית חדשה” ירדה מהסרגל ב-11.08.2026: האפליקציה **מקבלת** חשבוניות ספק ואינה מנפיקה אותן, ו„צילום מסמך” הוא מה שהחליף אותה; accountant מקבל „מרכז הבקרה”, „חשבוניות” ו„תשלומים”;
payer ו־supplier אינם מקבלים סרגל נוסף. צילום מסמך נשאר פקודה מרכזית ופותח את מצלמת/בורר הקבצים הילידיים.
