...
וסרגל פעולות מהירות תפקידי קבוע בתחתית. הסרגל התחתון הוא משטח פקודות וקיצורים, לא תחליף
...
**כל הקבוצות פתוחות בסרגל ובמגירת הטלפון (הכרעות בעלים 09.08 ו־13.08.2026).** „ניהול” ו„בקרה”
נולדו כ־disclosure מקופל, אבל הסתרת יעד מורשה הוסיפה קליק ומנעה סריקה ישירה של מבנה המערכת.
המימוש מרנדר אותן דרך ענף ה־**non-collapsible הקיים** ולא כ־`<details open>` כפוי: disclosure
שפתוח תמיד הוא פקד שמשקר על עצמו. במגירה החשבון נוסע בסוף הרשימה הגלילה ואינו מוצמד לתחתית,
כך שגם במסך נמוך היעדים אינם נחתכים.
