...
**בסרגל הדסקטופ הכול פתוח (הכרעת בעלים 09.08.2026).** „ניהול” ו„בקרה” נולדו כ־disclosure מקופל
בקמפיין הליטוש, בנימוק שהם יעדים נדירים וקיפולם מקצר את הרשימה היומית. **בטלפון הנימוק עומד**
והמגירה שומרת את הקיפול: היא overlay זמני שמתחרה בתוכן שמאחוריו. **בדסקטופ הוא לא עומד** — הסרגל
הוא טור קבוע ברוחב 240px עם מקום בשפע, והסתרת שישה יעדים מאחורי שני chevrons עולה קליק ולא קונה
כלום. המימוש מרנדר אותם דרך ענף ה־**non-collapsible הקיים** ולא כ־`<details open>` כפוי: disclosure
שפתוח תמיד הוא פקד שמשקר על עצמו.
...
הבקרה”, „צילום מסמך”, „קבלת סחורה” ויעד מסמכים מורשה. אצל `owner` היעד הוא „תפעול מסמכים”;
